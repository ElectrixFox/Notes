...
\begin{definition}[Independence of multiple events]\label{pre:prob:def:indepomulev}
...
\begin{definition}[Discrete random variable and probability mass function]\label{pre:prob:def:drvpmf}
...
\begin{definition}[Continuous random variable and probability density function]\label{pre:prob:def:crvandpdf}
...
\begin{theorem}[Expectation of a function of a random variable]\label{pre:prob:thm:lawofunconsciousstatistician}
...
\begin{theorem}[Expectation of a function of multiple random variables]\label{pre:prob:thm:multilawofunconsciousstatistician}
...
\begin{theorem}[Partition theorem for expectation]\label{pre:prob:thm:partthmforexp}
    Let $X$ be any real-valued random variable.
...
\begin{theorem}[Independence means multiply]\label{pre:prob:thm:expindepmeansmult}
...
\begin{theorem}[Monotonicity of expectation]\label{pre:prob:thm:monotonicityofexpectation}
